...
import com.flexipay.pancardocr.camera.CameraManager;
import com.flexipay.pancardocr.camera.ShutterButton;
import com.googlecode.tesseract.android.TessBaseAPI;

import com.flexipay.pancardocr.R;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  private Integer meanConfidence = 0;
  ...
  public void onCreate(Bundle icicle) {
    ...
    isFirstLaunch = prefs.getBoolean(PreferencesActivity.KEY_FIRST_LAUNCH, true);

    
    if (isFirstLaunch) {
      setDefaultPreferences();
      prefs.edit().putBoolean(PreferencesActivity.KEY_FIRST_LAUNCH, false).commit();
    }
  ...
  private void initOcrEngine(File storageRoot, String languageCode, String languageName) {    
    ...
    SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
    boolean assetsCopied = prefs.getBoolean(PreferencesActivity.KEY_ASSETS_COPIED, false);
    
    // Start AsyncTask to install language data and init OCR
    baseApi = new TessBaseAPI();
    new OcrInitAsyncTask(this, baseApi, dialog, indeterminateDialog, languageCode, languageName, ocrEngineMode, assetsCopied)
  ...
  void handleOcrContinuousDecode(OcrResult ocrResult) {
    ...
    Integer meanConf = ocrResult.getMeanConfidence();
    if(meanConf> meanConfidence) {
    ...
    if (CONTINUOUS_DISPLAY_METADATA) {
      ...
      statusViewBottom.setText("Mean confidence: " + 
