...
package com.flexipay.pancardocr.camera;
...
import com.flexipay.pancardocr.PlanarYUVLuminanceSource;
import com.flexipay.pancardocr.PreferencesActivity;
...
public final class CameraManager {
  ...
  private static final int MIN_FRAME_WIDTH = 20;//50; // originally 240
  private static final int MIN_FRAME_HEIGHT = 11;//20; // originally 240
  ...
  public synchronized Rect getFramingRect() {
    if (framingRect == null) {
      ...
      int height = screenResolution.y * 3/5; //1/5;
